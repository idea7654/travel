...
const Kagawa = () => {
    ...
    const text = ">詳しい情報はこちらをクリックしてください！<";
    return (
        <div>
            <div style={{display: 'table', position: "absolute", left: "35%", bottom: "70%", width: "30%", height: "10%", textAlign: "center", border: "double"}}>
                <div style={{display: "table-cell", verticalAlign: "middle"}} onClick={() => setShowModal(true)}>
                    香川県
                    <br/>
                    {text}
                </div>
                            ...
                            <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                                ...
                                <div className="flex items-center justify-end p-6 border-t border-solid border-gray-300 rounded-b">
                                    <button className="text-red-500 background-transparent font-bold uppercase px-6 py-2 text-sm outline-none focus:outline-none mr-1 mb-1"
                                        type="button" style={{ transition: "all .15s ease" }} onClick={() => setShowModal(false)}>
                                        Close
                                    </button>
